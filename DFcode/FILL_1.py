...
def main():
    ...
    mapping_file = 'D:\\20220916\\laiye\\东风项目\\流程录屏和相关资料\\QIS，redmine表格汇总自动化\\对应映射.txt'
    csv_file = 'D:\\20220916\\laiye\\东风项目\\流程录屏和相关资料\\QIS，redmine表格汇总自动化\\测试文件\\alm_issues合并结果.csv'
    excel_file = 'D:\\20220916\\laiye\\东风项目\\流程录屏和相关资料\\QIS，redmine表格汇总自动化\\测试文件\\测试.xlsx'
    output_file = '测试_更新后.xlsx'

    print("简单列映射处理工具")
    print("=" * 50)
    print("功能: 将CSV的整列数据直接复制到Excel对应列")
